...
public interface Statistics<T extends Number>
{
	 ...
	 * The data currently stored in this Statistics object will be assigned to the 
	 * new StatObject.
	 */
	 ...
	 */
	ArrayList<ArrayList<T>> MapCar();
	
	/**
	 * A flag indicating what data should be read from the weather input file.
	 */
	public enum DATA
	{USAF, WBAN, YR_MO_DA_HR_MN /* Year, Month, Day, Hour, Minute */, DIR, SPD, GUS, 
		CLG, SKC, L, M, H, VSB, MW_1, MW_2, MW_3, MW_4, AW_1, AW_2, AW_3, AW_4, W, TEMP, 
		DEWP, SLP,ALT,ST, MAX, MIN, PCP01, PCP06, PCP24, PCPXX, SD}
}